...
const Navbar = () => {
  ...
  const [showUserInfo, setShowUserInfo] = useState(false); // for toggling user info box
          ...
          <div className="navbar-nav ms-auto">
            <div className="btn-group" role="group">
              ...
              <Link
                ...
                Wishlist <i className="bi bi-heart"></i>
                <span className="position-absolute top-0 me-5 mt-2 start-100 translate-middle badge rounded-pill bg-danger" style={{ fontSize: "0.7rem" }}>
                  {wishlistCount}
                </span>
              </Link>
              ...
              <Link to="/orders" className="nav-link pe-2 px-3 position-relative">
                ...
                <div className="position-relative">
                  ...
                  {showUserInfo && (
                    <div
                      ...
                      style={{ top: "50px", right: "0", minWidth: "200px", zIndex: 1 }}>
                      <p className="mb-1"><strong>Name:</strong> {user.name || "User"}</p>
